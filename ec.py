...
def generate_wrapper(
    ...
    def parse_module(module_str: str) -> Tuple[str, List[Dict], List[Dict], List[Dict]]:
        ...
        module_str_no_comments = re.sub(
            r"/\*.*?\*/", "", module_str_no_comments, flags=re.DOTALL
        )
    ...
    # Parse both modules
    module1_name, module1_inputs, module1_outputs, module1_params = parse_module(
        module1_str
    )
    module2_name, module2_inputs, module2_outputs, module2_params = parse_module(
        module2_str
    )
